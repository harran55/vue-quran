...
export default {
    ...
    data() {
        return {
            ...
            reayah: 0,
            options: [
                { text: 'سيتم تكرار قرائة الصفحة', value: 'page' },
                { text: 'سيتم تكرار قرائة الآية ثلاث مرات', value: 'ayah' },
                { text: 'سيتم الانتقال الى الصفحة التالية بعد الأنتهى من قرائة الصفحة', value: 'next' },
            ]
        }
    },
    methods: {
