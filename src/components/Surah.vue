<template>
  <div class="surah">
    <b-container class="col-8">
      <b-form-group label="البحث السريع" class="col-6 text-right mb-5 m-auto">
        <b-form-input
          v-model="keyword"
          placeholder="قم بأدخال رقم او اسم السورة"
        ></b-form-input>
      </b-form-group>
      <ul class="ul">
...
<script>
import jsonSurah from "@/assets/Surah.json";
